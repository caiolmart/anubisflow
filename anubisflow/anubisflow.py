...
class AnubisFG:
    ...
    def _generate_features_twotupleuni(self,
        ...
        return [
            qt_pkt,
            zero_if_not_exists(mem.pkt_protocol_counter, 6),
            zero_if_not_exists(mem.pkt_protocol_counter, 17),
            zero_if_not_exists(mem.pkt_protocol_counter, 1),
            zero_if_not_exists(mem.pkt_protocol_counter, 4),
    ...
    def _generate_features_twotuplebi(self,
        ...
        features = [
            ...
            zero_if_not_exists(mem.fwd_pkt_protocol_counter, 17),
            zero_if_not_exists(mem.fwd_pkt_protocol_counter, 1),
            zero_if_not_exists(mem.fwd_pkt_protocol_counter, 4),
            ...
            # bck
            bck_qt_pkt,
            zero_if_not_exists(mem.bck_pkt_protocol_counter, 6),
            zero_if_not_exists(mem.bck_pkt_protocol_counter, 17),
            zero_if_not_exists(mem.bck_pkt_protocol_counter, 1),
            zero_if_not_exists(mem.bck_pkt_protocol_counter, 4),
